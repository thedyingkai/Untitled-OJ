...
mkdir -m 0700 "$source_storage"
mkdir -m 0700 "$source_storage/problems" "$source_storage/submissions"
mkdir -m 0700 "$source_storage/problems/drill" "$source_storage/submissions/drill"
