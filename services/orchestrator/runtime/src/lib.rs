...
// Compatibility exports keep existing runtime consumers source-compatible.
pub use orchestrator_protocol::{
    DEFAULT_COMPENSATION_TIMEOUT_MS, DEFAULT_HEALTH_POLL_INTERVAL_MS, DEFAULT_HEALTH_TIMEOUT_MS,
    DeploymentRuntimeObservationV1, DockerRuntimeFacts, HealthGatePolicy,
    JUDGE_SANDBOX_V1_CANONICAL_JSON, JUDGE_SANDBOX_V1_HEALTH_POLL_INTERVAL_MS,
    JUDGE_SANDBOX_V1_HEALTH_TIMEOUT_MS, JUDGE_SANDBOX_V1_PROFILE_ID,
    JUDGE_SANDBOX_V1_PROFILE_SHA256, MAX_COMPENSATION_TIMEOUT_MS, MAX_HEALTH_TIMEOUT_MS,
    ManagedDeploymentInventoryV1, MissingHealthcheckPolicy, RuntimeContract, RuntimeDesiredState,
    RuntimeError, RuntimeInstance, RuntimeObservedState, RuntimeProfile,
    STANDARD_RUNTIME_PROFILE_CANONICAL_JSON, STANDARD_RUNTIME_PROFILE_ID,
