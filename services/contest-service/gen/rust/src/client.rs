...
pub const ADMINLISTCONTESTS: Operation = Operation { id: "adminListContests", method: "GET", path: "/admin/contests", audience: "admin", permission: Some("contest-service.contest.manage"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTCONTESTS: Operation = Operation { id: "listContests", method: "GET", path: "/contests", audience: "user", permission: Some("contest-service.contest.read"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const CREATECONTEST: Operation = Operation { id: "createContest", method: "POST", path: "/contests", audience: "user", permission: Some("contest-service.contest.manage"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const DELETECONTEST: Operation = Operation { id: "deleteContest", method: "DELETE", path: "/contests/{contestId}", audience: "user", permission: Some("contest-service.contest.manage"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETCONTEST: Operation = Operation { id: "getContest", method: "GET", path: "/contests/{contestId}", audience: "user", permission: Some("contest-service.contest.read"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const UPDATECONTEST: Operation = Operation { id: "updateContest", method: "PUT", path: "/contests/{contestId}", audience: "user", permission: Some("contest-service.contest.manage"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const CONTESTHEALTH: Operation = Operation { id: "contestHealth", method: "GET", path: "/healthz", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const CONTESTREADY: Operation = Operation { id: "contestReady", method: "GET", path: "/readyz", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
