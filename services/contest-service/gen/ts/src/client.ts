...
export const operations = {
  "adminListContests": { id: "adminListContests", method: "GET", path: "/admin/contests", audience: "admin", permission: "contest-service.contest.manage", headerParameters: [], requestContentTypes: [], requestBodyRequired: false } as const,
  "listContests": { id: "listContests", method: "GET", path: "/contests", audience: "user", permission: "contest-service.contest.read", headerParameters: [], requestContentTypes: [], requestBodyRequired: false } as const,
  "createContest": { id: "createContest", method: "POST", path: "/contests", audience: "user", permission: "contest-service.contest.manage", headerParameters: [], requestContentTypes: ["application/json"], requestBodyRequired: true } as const,
  "deleteContest": { id: "deleteContest", method: "DELETE", path: "/contests/{contestId}", audience: "user", permission: "contest-service.contest.manage", headerParameters: [], requestContentTypes: [], requestBodyRequired: false } as const,
  "getContest": { id: "getContest", method: "GET", path: "/contests/{contestId}", audience: "user", permission: "contest-service.contest.read", headerParameters: [], requestContentTypes: [], requestBodyRequired: false } as const,
  "updateContest": { id: "updateContest", method: "PUT", path: "/contests/{contestId}", audience: "user", permission: "contest-service.contest.manage", headerParameters: [], requestContentTypes: ["application/json"], requestBodyRequired: true } as const,
  "contestHealth": { id: "contestHealth", method: "GET", path: "/healthz", audience: "internal", headerParameters: [], requestContentTypes: [], requestBodyRequired: false } as const,
  "contestReady": { id: "contestReady", method: "GET", path: "/readyz", audience: "internal", headerParameters: [], requestContentTypes: [], requestBodyRequired: false } as const,
...
export class Client {
  ...
  adminlistcontests(options: CallOptions = {}): Promise<Response> {
    return this.call(operations["adminListContests"], options);
  }

  listcontests(options: CallOptions = {}): Promise<Response> {
    return this.call(operations["listContests"], options);
  }

  createcontest(options: CallOptions = {}): Promise<Response> {
    return this.call(operations["createContest"], options);
  }

  deletecontest(options: CallOptions = {}): Promise<Response> {
    return this.call(operations["deleteContest"], options);
  }

  getcontest(options: CallOptions = {}): Promise<Response> {
    return this.call(operations["getContest"], options);
  }

  updatecontest(options: CallOptions = {}): Promise<Response> {
    return this.call(operations["updateContest"], options);
  }

  contesthealth(options: CallOptions = {}): Promise<Response> {
    return this.call(operations["contestHealth"], options);
  }

  contestready(options: CallOptions = {}): Promise<Response> {
    return this.call(operations["contestReady"], options);
  }
}
