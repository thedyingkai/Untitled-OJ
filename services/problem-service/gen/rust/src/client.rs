...
pub const LISTARTIFACTGCINTENTS: Operation = Operation { id: "listArtifactGCIntents", method: "GET", path: "/admin/artifact-gc/intents", audience: "admin", permission: Some("problem.manage.data"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const RECONCILEARTIFACTGCINTENT: Operation = Operation { id: "reconcileArtifactGCIntent", method: "POST", path: "/admin/artifact-gc/intents/reconcile", audience: "admin", permission: Some("problem.manage.data"), header_parameters: &[HeaderParameter { name: "Idempotency-Key", required: true }], request_content_types: &["application/json"], request_body_required: true };
pub const RETRYARTIFACTGCINTENT: Operation = Operation { id: "retryArtifactGCIntent", method: "POST", path: "/admin/artifact-gc/intents/retry", audience: "admin", permission: Some("problem.manage.data"), header_parameters: &[HeaderParameter { name: "Idempotency-Key", required: true }], request_content_types: &["application/json"], request_body_required: true };
pub const ADMINLISTPROBLEMS: Operation = Operation { id: "adminListProblems", method: "GET", path: "/admin/problems", audience: "admin", permission: Some("problem.edit"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const CREATEPROBLEM: Operation = Operation { id: "createProblem", method: "POST", path: "/problems", audience: "admin", permission: Some("problem.create"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const DELETEPROBLEM: Operation = Operation { id: "deleteProblem", method: "DELETE", path: "/problems/{id}", audience: "admin", permission: Some("problem.delete"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const UPDATEPROBLEM: Operation = Operation { id: "updateProblem", method: "PUT", path: "/problems/{id}", audience: "admin", permission: Some("problem.edit"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const PROBLEMHEALTH: Operation = Operation { id: "problemHealth", method: "GET", path: "/healthz", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTPROBLEMS: Operation = Operation { id: "listProblems", method: "GET", path: "/problems", audience: "user", permission: Some("problem.view"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETPROBLEM: Operation = Operation { id: "getProblem", method: "GET", path: "/problems/{id}", audience: "user", permission: Some("problem.view"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const PROBLEMREADY: Operation = Operation { id: "problemReady", method: "GET", path: "/readyz", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETPROBLEMPACKAGE: Operation = Operation { id: "getProblemPackage", method: "GET", path: "/problems/{id}/package", audience: "user", permission: Some("problem.testdata.read"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTPACKAGECASES: Operation = Operation { id: "listPackageCases", method: "GET", path: "/problems/{id}/package/cases", audience: "user", permission: Some("problem.testdata.read"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTTESTCASES: Operation = Operation { id: "listTestCases", method: "GET", path: "/problems/{id}/test-cases", audience: "user", permission: Some("problem.testdata.read"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const VALIDATEPROBLEMPACKAGE: Operation = Operation { id: "validateProblemPackage", method: "POST", path: "/problems/{id}/package/validate", audience: "admin", permission: Some("problem.testdata.read"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const ADDTESTCASE: Operation = Operation { id: "addTestCase", method: "POST", path: "/problems/{id}/test-cases", audience: "admin", permission: Some("problem.testdata.write"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const DELETETESTCASE: Operation = Operation { id: "deleteTestCase", method: "DELETE", path: "/problems/{id}/test-cases/{case_no}", audience: "admin", permission: Some("problem.testdata.write"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const UPDATETESTCASE: Operation = Operation { id: "updateTestCase", method: "PUT", path: "/problems/{id}/test-cases/{case_no}", audience: "admin", permission: Some("problem.testdata.write"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };

pub const OPERATIONS: &[Operation] = &[
    LISTARTIFACTGCINTENTS,
    RECONCILEARTIFACTGCINTENT,
    RETRYARTIFACTGCINTENT,
    ADMINLISTPROBLEMS,
    CREATEPROBLEM,
    DELETEPROBLEM,
    UPDATEPROBLEM,
