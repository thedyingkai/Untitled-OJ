...
pub const GETJUDGEQUEUE: Operation = Operation { id: "getJudgeQueue", method: "GET", path: "/judge/admin/queue", audience: "admin", permission: Some("judge.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETJUDGEQUEUESTATUS: Operation = Operation { id: "getJudgeQueueStatus", method: "GET", path: "/judge/admin/queue/status", audience: "admin", permission: Some("judge.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const REQUEUESUBMISSION: Operation = Operation { id: "requeueSubmission", method: "POST", path: "/judge/admin/submissions/{id}/requeue", audience: "admin", permission: Some("judge.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const CREATESUBMISSION: Operation = Operation { id: "createSubmission", method: "POST", path: "/judge/submissions", audience: "user", permission: Some("judge.submit"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const JUDGEHEALTH: Operation = Operation { id: "judgeHealth", method: "GET", path: "/healthz", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTJUDGELANGUAGES: Operation = Operation { id: "listJudgeLanguages", method: "GET", path: "/judge/languages", audience: "user", permission: Some("judge.submission.view.own"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const REJUDGEPROBLEM: Operation = Operation { id: "rejudgeProblem", method: "POST", path: "/judge/problems/{id}/rejudge", audience: "admin", permission: Some("judge.submission.manage"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTSUBMISSIONS: Operation = Operation { id: "listSubmissions", method: "GET", path: "/judge/submissions", audience: "user", permission: Some("judge.submission.view.own"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETSUBMISSION: Operation = Operation { id: "getSubmission", method: "GET", path: "/judge/submissions/{id}", audience: "user", permission: Some("judge.submission.view.own"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const CANCELSUBMISSION: Operation = Operation { id: "cancelSubmission", method: "POST", path: "/judge/submissions/{id}/cancel", audience: "user", permission: Some("judge.submission.manage"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: false };
pub const GETSUBMISSIONCASES: Operation = Operation { id: "getSubmissionCases", method: "GET", path: "/judge/submissions/{id}/cases", audience: "user", permission: Some("judge.submission.view.own"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETSUBMISSIONDEBUGLOGS: Operation = Operation { id: "getSubmissionDebugLogs", method: "GET", path: "/judge/submissions/{id}/debug-logs", audience: "user", permission: Some("judge.submission.view.all"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const JUDGEREADY: Operation = Operation { id: "judgeReady", method: "GET", path: "/readyz", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETWORKERPROBLEMPACKAGE: Operation = Operation { id: "getWorkerProblemPackage", method: "GET", path: "/api/judge/worker/artifacts/problems/{id}/package", audience: "internal", permission: Some("judge.worker"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETWORKERSUBMISSIONSOURCE: Operation = Operation { id: "getWorkerSubmissionSource", method: "GET", path: "/api/judge/worker/artifacts/submissions/{id}/source", audience: "internal", permission: Some("judge.worker"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const HEARTBEATJUDGEWORKER: Operation = Operation { id: "heartbeatJudgeWorker", method: "POST", path: "/api/judge/worker/heartbeat", audience: "internal", permission: Some("judge.worker"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const REGISTERJUDGEWORKER: Operation = Operation { id: "registerJudgeWorker", method: "POST", path: "/api/judge/worker/register", audience: "internal", permission: Some("judge.worker"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const CLAIMJUDGETASKS: Operation = Operation { id: "claimJudgeTasks", method: "POST", path: "/api/judge/worker/tasks/claim", audience: "internal", permission: Some("judge.worker"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const FAILJUDGETASK: Operation = Operation { id: "failJudgeTask", method: "POST", path: "/api/judge/worker/tasks/{task_id}/fail", audience: "internal", permission: Some("judge.worker"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const HEARTBEATJUDGETASK: Operation = Operation { id: "heartbeatJudgeTask", method: "POST", path: "/api/judge/worker/tasks/{task_id}/heartbeat", audience: "internal", permission: Some("judge.worker"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const COMPLETEJUDGETASK: Operation = Operation { id: "completeJudgeTask", method: "POST", path: "/api/judge/worker/tasks/{task_id}/result", audience: "internal", permission: Some("judge.worker"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const LISTJUDGETASKS: Operation = Operation { id: "listJudgeTasks", method: "GET", path: "/judge/admin/tasks", audience: "admin", permission: Some("judge.worker.status"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTJUDGEWORKERS: Operation = Operation { id: "listJudgeWorkers", method: "GET", path: "/judge/admin/workers", audience: "admin", permission: Some("judge.worker.status"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const DRAINJUDGEWORKER: Operation = Operation { id: "drainJudgeWorker", method: "POST", path: "/judge/admin/workers/{id}/drain", audience: "admin", permission: Some("judge.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
...
pub const OPERATIONS: &[Operation] = &[
    ...
    JUDGEREADY,
    GETWORKERPROBLEMPACKAGE,
    GETWORKERSUBMISSIONSOURCE,
    HEARTBEATJUDGEWORKER,
    REGISTERJUDGEWORKER,
    CLAIMJUDGETASKS,
    FAILJUDGETASK,
    HEARTBEATJUDGETASK,
