...
func (l *PutObjectLogic) PutObject(req *types.ObjectReq, contentType string, body io.Reader) (resp *types.ObjectMetadata, err error) {
	meta, err := l.svcCtx.ObjectStore.Put(req.Bucket, req.Key, contentType, body)
	if err != nil {
		return nil, err
	}
	return &meta, nil
