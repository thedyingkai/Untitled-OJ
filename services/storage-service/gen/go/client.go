...
var Operations = map[string]Operation{
	"deleteStorageObject": {ID: "deleteStorageObject", Method: "DELETE", Path: "/{bucket}/{key}", Audience: "internal", Permission: "storage.object.delete", HeaderParameters: []HeaderParameter{{Name: "X-OJOS-Expected-Sha256", Required: true}, {Name: "X-OJOS-Expected-Size", Required: true}}, RequestContentTypes: nil, RequestBodyRequired: false},
	"storageHealth": {ID: "storageHealth", Method: "GET", Path: "/healthz", Audience: "internal", Permission: "", HeaderParameters: nil, RequestContentTypes: nil, RequestBodyRequired: false},
	"storageReady": {ID: "storageReady", Method: "GET", Path: "/readyz", Audience: "internal", Permission: "", HeaderParameters: nil, RequestContentTypes: nil, RequestBodyRequired: false},
	"getStorageObject": {ID: "getStorageObject", Method: "GET", Path: "/{bucket}/{key}", Audience: "internal", Permission: "storage.object.read", HeaderParameters: nil, RequestContentTypes: nil, RequestBodyRequired: false},
	"headStorageObject": {ID: "headStorageObject", Method: "HEAD", Path: "/{bucket}/{key}", Audience: "internal", Permission: "storage.object.read", HeaderParameters: nil, RequestContentTypes: nil, RequestBodyRequired: false},
	"putStorageObject": {ID: "putStorageObject", Method: "PUT", Path: "/{bucket}/{key}", Audience: "internal", Permission: "storage.object.write", HeaderParameters: []HeaderParameter{{Name: "If-None-Match", Required: false}, {Name: "X-OJOS-Content-Sha256", Required: false}}, RequestContentTypes: []string{"application/octet-stream"}, RequestBodyRequired: true},
}
...
func (c *Client) DeleteStorageObject(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte) (*http.Response, error) {
	return c.Do(ctx, Operations["deleteStorageObject"], pathParameters, query, body)
}

func (c *Client) DeleteStorageObjectWithOptions(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte, options CallOptions) (*http.Response, error) {
	return c.DoWithOptions(ctx, Operations["deleteStorageObject"], pathParameters, query, body, options)
}

func (c *Client) StorageHealth(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte) (*http.Response, error) {
	return c.Do(ctx, Operations["storageHealth"], pathParameters, query, body)
}

func (c *Client) StorageHealthWithOptions(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte, options CallOptions) (*http.Response, error) {
	return c.DoWithOptions(ctx, Operations["storageHealth"], pathParameters, query, body, options)
}

func (c *Client) StorageReady(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte) (*http.Response, error) {
	return c.Do(ctx, Operations["storageReady"], pathParameters, query, body)
}

func (c *Client) StorageReadyWithOptions(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte, options CallOptions) (*http.Response, error) {
	return c.DoWithOptions(ctx, Operations["storageReady"], pathParameters, query, body, options)
}

func (c *Client) GetStorageObject(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte) (*http.Response, error) {
	return c.Do(ctx, Operations["getStorageObject"], pathParameters, query, body)
}

func (c *Client) GetStorageObjectWithOptions(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte, options CallOptions) (*http.Response, error) {
	return c.DoWithOptions(ctx, Operations["getStorageObject"], pathParameters, query, body, options)
}

func (c *Client) HeadStorageObject(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte) (*http.Response, error) {
	return c.Do(ctx, Operations["headStorageObject"], pathParameters, query, body)
}

func (c *Client) HeadStorageObjectWithOptions(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte, options CallOptions) (*http.Response, error) {
	return c.DoWithOptions(ctx, Operations["headStorageObject"], pathParameters, query, body, options)
}

func (c *Client) PutStorageObject(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte) (*http.Response, error) {
	return c.Do(ctx, Operations["putStorageObject"], pathParameters, query, body)
}

func (c *Client) PutStorageObjectWithOptions(ctx context.Context, pathParameters map[string]string, query url.Values, body []byte, options CallOptions) (*http.Response, error) {
	return c.DoWithOptions(ctx, Operations["putStorageObject"], pathParameters, query, body, options)
}
