...
pub const LISTGATEWAYENDPOINTGROUPS: Operation = Operation { id: "listGatewayEndpointGroups", method: "GET", path: "/api/admin/endpoint-groups", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETGATEWAYADMINHEALTH: Operation = Operation { id: "getGatewayAdminHealth", method: "GET", path: "/api/admin/health", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTGATEWAYORCHESTRATORROUTES: Operation = Operation { id: "listGatewayOrchestratorRoutes", method: "GET", path: "/api/admin/orchestrator/routes", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const RELOADGATEWAYORCHESTRATORROUTES: Operation = Operation { id: "reloadGatewayOrchestratorRoutes", method: "POST", path: "/api/admin/orchestrator/routes/reload", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &["application/json"], request_body_required: false };
pub const GETGATEWAYORCHESTRATORSNAPSHOT: Operation = Operation { id: "getGatewayOrchestratorSnapshot", method: "GET", path: "/api/admin/orchestrator/snapshot", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTGATEWAYSERVICES: Operation = Operation { id: "listGatewayServices", method: "GET", path: "/api/admin/services", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTGATEWAYSERVICESTATUSES: Operation = Operation { id: "listGatewayServiceStatuses", method: "GET", path: "/api/admin/services/status", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const LISTGATEWAYSERVICEOPERATIONS: Operation = Operation { id: "listGatewayServiceOperations", method: "GET", path: "/api/admin/services/status/operations", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETGATEWAYSERVICEOPERATION: Operation = Operation { id: "getGatewayServiceOperation", method: "GET", path: "/api/admin/services/status/operations/{id}", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETGATEWAYSERVICESTATUS: Operation = Operation { id: "getGatewayServiceStatus", method: "GET", path: "/api/admin/services/status/{id}", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETGATEWAYSERVICE: Operation = Operation { id: "getGatewayService", method: "GET", path: "/api/admin/services/{id}", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETGATEWAYSERVICETOPOLOGY: Operation = Operation { id: "getGatewayServiceTopology", method: "GET", path: "/api/admin/topology", audience: "internal", permission: Some("system.admin"), header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETGATEWAYUSERCONTRIBUTIONSNAPSHOT: Operation = Operation { id: "getGatewayUserContributionSnapshot", method: "GET", path: "/api/v1/contributions/snapshot", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const DELETEGATEWAYTOPOLOGYPROJECTION: Operation = Operation { id: "deleteGatewayTopologyProjection", method: "DELETE", path: "/api/v1/topologies/{id}", audience: "internal", permission: None, header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const GETGATEWAYTOPOLOGYPROJECTION: Operation = Operation { id: "getGatewayTopologyProjection", method: "GET", path: "/api/v1/topologies/{id}", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const APPLYGATEWAYTOPOLOGYPROJECTION: Operation = Operation { id: "applyGatewayTopologyProjection", method: "PUT", path: "/api/v1/topologies/{id}", audience: "internal", permission: None, header_parameters: &[], request_content_types: &["application/json"], request_body_required: true };
pub const GETGATEWAYCOMPATIBILITYHEALTH: Operation = Operation { id: "getGatewayCompatibilityHealth", method: "GET", path: "/health", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETGATEWAYLIVENESS: Operation = Operation { id: "getGatewayLiveness", method: "GET", path: "/healthz", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETGATEWAYMETRICS: Operation = Operation { id: "getGatewayMetrics", method: "GET", path: "/metrics", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };
pub const GETGATEWAYREADINESS: Operation = Operation { id: "getGatewayReadiness", method: "GET", path: "/readyz", audience: "internal", permission: None, header_parameters: &[], request_content_types: &[], request_body_required: false };

pub const OPERATIONS: &[Operation] = &[
    LISTGATEWAYENDPOINTGROUPS,
    GETGATEWAYADMINHEALTH,
    LISTGATEWAYORCHESTRATORROUTES,
    RELOADGATEWAYORCHESTRATORROUTES,
    GETGATEWAYORCHESTRATORSNAPSHOT,
    LISTGATEWAYSERVICES,
    LISTGATEWAYSERVICESTATUSES,
    LISTGATEWAYSERVICEOPERATIONS,
    GETGATEWAYSERVICEOPERATION,
    GETGATEWAYSERVICESTATUS,
    GETGATEWAYSERVICE,
    GETGATEWAYSERVICETOPOLOGY,
    GETGATEWAYUSERCONTRIBUTIONSNAPSHOT,
    DELETEGATEWAYTOPOLOGYPROJECTION,
    GETGATEWAYTOPOLOGYPROJECTION,
    APPLYGATEWAYTOPOLOGYPROJECTION,
    GETGATEWAYCOMPATIBILITYHEALTH,
    GETGATEWAYLIVENESS,
    GETGATEWAYMETRICS,
    GETGATEWAYREADINESS,
];
